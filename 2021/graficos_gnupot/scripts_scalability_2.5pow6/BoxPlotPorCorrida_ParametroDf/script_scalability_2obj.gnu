...
set output "fin_distance_factor_2obj.eps" 
set key font ",18"
set yrange [0.86:0.96]
set ylabel "Normalized HV"
#set xlabel "Last moment in which the diversity is explicitly promoted"
set xlabel "FMDP"
#set title "Several configurations for the linear model with two objectives"
set title "Two-objective problems"
set autoscale xfix
#set format x "%.0f%%"
...
plot for [i=0:STATS_blocks-1] "BOXPLOT/VSDMOEA_2" using (0.1+0.1*i):2 index i lt 1 lc rgb 'white'title ""
#plot for [i=0:STATS_blocks-1] "BOXPLOT/VSDMOEA_2" using (10+10*i):2 index i lt 1 lc rgb 'white'title ""
