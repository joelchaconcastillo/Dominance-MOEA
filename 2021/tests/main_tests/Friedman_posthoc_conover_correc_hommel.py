...
def Friedman_Posthoc_dunn_score():
...
def Friedman_Posthoc_dunn_info():
  print("Friedman test with posthoc dunn and holm correction")
  list_files = open(sys.argv[1], "r")
  for inst in list_files.read().split('\n'):
    if len(inst)==0:
        continue
...
Friedman_Posthoc_dunn_score()
#Friedman_Posthoc_dunn_info()
