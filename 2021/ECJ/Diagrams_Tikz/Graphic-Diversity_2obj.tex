...
\addplot[blue,dotted,mark=triangle*] table[y= CPDEA_Position_50,x=X]{\DiversityTwoWFG};
...
\addplot[blue,solid,mark=triangle*] table[y= CPDEA_Position_100,x=X]{\DiversityTwoWFG};
...
\addplot[blue,loosely dashdotted,mark=triangle*] table[y= CPDEA_Position_250,x=X]{\DiversityTwoWFG};
...
\addplot[blue,dotted,mark=triangle*] table[y= CPDEA_Distance_50,x=X]{\DiversityTwoWFG};
	\addlegendentry{CPDEA (50)}
...
%	\addlegendentry{VSD-MOEA (100)}
%
%\addplot[blue,solid,mark=triangle*] table[y= CPDEA_Distance_100,x=X]{\DiversityTwoWFG};
%	\addlegendentry{CPDEA (100)}
%		
...
\addplot[blue,loosely dashdotted,mark=triangle*] table[y= CPDEA_Distance_250,x=X]{\DiversityTwoWFG};
	\addlegendentry{CPDEA (250)}
...
%%
%%\addplot[blue,dotted,mark=triangle*] table[y= CPDEA,x=X]{\DiversityTwoWFGOne};
