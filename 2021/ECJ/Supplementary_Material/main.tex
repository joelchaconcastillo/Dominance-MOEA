...
\title{\bf Supplementary Document for ``VSD-MOEA: A Dominance-Based Multi-Objective Evolutionary Algorithm with Explicit Variable Space Diversity Management''}
