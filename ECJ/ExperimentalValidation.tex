...
%
The figure~\ref{fig:variable-decision-scalability} shows the mean \HV{} ratio for the four algorithms tested,
...
in the single-objective case~\citep{Joel:GDE3_CEC09}.
...
%
The figure~\ref{fig:Diversity} shows how the ADI evolves for the two-objective (left side) and three-objective (right side) problems.
...
This section ilustrates the main reason of why the superiority of the \VSDMOEA{} against state-of-the-art algorithms in long-term executions.
%
...
The figure~\ref{fig:Performance_time} shows the mean \HV{} ratio obtained with each \MOEA{} 
...
%
The higher this value is, the greater the exploración of the decision variable space.
%
In an opposed way, the lower this value is, the less space exploration will be.
%
