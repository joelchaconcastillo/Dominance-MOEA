...
%
Mainly, the sets $FP$ and $FR$ are employed referring to the survivors and candidates individuals that belong to the current front $F$ respectively (lines \ref{alg:FR} and \ref{alg:FS}).
%
