...
\markboth{IEEE Transactions on Cybernetics,~Vol.~XX, No.~X, Month~Year}{Chac\'{o}n 
\MakeLowercase{\textit{et al.}}: VSD-MOEA: A Dominance-Based Multi-Objective 
Evolutionary Algorithm with Explicit Variable Space Diversity Management}
...
bioinformatic from the Instituto Tecnol\'ogico Superior de Irapuato, in 2014. In 2017 recieved the master's degree 
in computer science in the field of multi-objective optimization from the Center for Reseach in Mathematics, M\'exico.

%
%
He has participated in several international congress with works highly related to the diversity topics in evolutionary algorithms.

%
He is currently working toward the Ph.D. degree, and his current research interests are multi-objective optimization, memetic algorithms,  and machine learning.
%
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip]{Photo_Authors/coello.eps}}]{\bf Carlos A. Coello Coello} (M'98-SM'04-F'11) received
a Ph.D. in computer science from Tulane University, New Orleans, Louisiana, USA, in 1996. He is a Professor
with Distinction (CINVESTAV-3F Researcher) at the Department of Computer Science of CINVESTAV-IPN,
Mexico City, M\'{e}xico. He has authored and co-authored over 480 technical papers and book chapters.
His publications currently report over 45,800 citations in {\em Google Scholar} (his h-index is 83).
His research interests include evolutionary multiobjective optimization and constraint-handling techniques for evolutionary algorithms.
Dr. Coello Coello was a recipient of the {\em 2007 National Research Award} from the Mexican Academy of Sciences in the
area of {\em Exact Sciences}, the {\em 2013 IEEE Kiyo Tomiyasu Award}, the {\em 2012 National Medal of  Science and Arts} in the area of {\em Physical,
Mathematical and Natural Sciences} and the {\em 2016 The World Academy of Sciences Award} in {\em Engineering Sciences}. He 
is an Associate Editor of {\em IEEE Transactions on Evolutionary Computation}
and serves on the editorial board of several other international journals. 
He is a member of the Association for Computing Machinery, Sigma Xi, and the Mexican Academy of Sciences.
\end{IEEEbiography}
