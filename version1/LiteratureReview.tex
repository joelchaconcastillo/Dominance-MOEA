...
%
A popular approach to promote the diversity of the decision space is the application of fitness sharing~\cite{Joel:NPGA} 
...
%
Another \MOEA{} designed to promote diversity of both the decision and the objective space is the Genetic
...
%
The first one promotes diversity and quality of the objective space whereas the second one promotes diversity of the decision space.
%
