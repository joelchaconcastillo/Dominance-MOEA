...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (111, 124) circle [x radius= 9.3, y radius= 9.3]   ;
\draw (111,124) node [scale=0.5] [align=left] {5};
% Text Node
...
% Text Node
\draw    (195, 116) circle [x radius= 9.3, y radius= 9.3]   ;
\draw (195,116) node [scale=0.5] [align=left] {6};
% Text Node
...
% Text Node
\draw    (197, 180) circle [x radius= 9.3, y radius= 9.3]   ;
\draw (197,180) node [scale=0.5] [align=left] {4};
% Text Node
...
% Text Node
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=1 ]  (339, 98) circle [x radius= 9.3, y radius= 9.3]   ;
...
% Text Node
\draw    (386, 116) circle [x radius= 9.3, y radius= 9.3]   ;
...
% Text Node
\draw    (398, 154) circle [x radius= 9.3, y radius= 9.3]   ;
