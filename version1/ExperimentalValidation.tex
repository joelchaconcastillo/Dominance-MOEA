...
%
Note that for the indicator-based category, \textsc{sms-emoa} was also taken into account initially.
%
...
%
Finally, when using more than $2.5 \times 10^4$ function evaluations, the \HV{} ratio obtained by \VSDMOEA{} is much higher than the one
