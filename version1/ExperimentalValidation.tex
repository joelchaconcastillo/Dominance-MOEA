...
%
Particularly, the position parameters $k$ and distance parameters $l$ where set taking into account the formulas $k=(4/24) \times n$ and $l=(20/24) \times n$, respectively.
%
