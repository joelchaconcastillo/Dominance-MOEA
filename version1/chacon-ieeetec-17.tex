...
\pgfplotstableread[col sep = comma]{CSV/Scalability_DTLZ4_2obj.csv}\ScalabilityDTLZFourTwoObj
\pgfplotstableread[col sep = comma]{CSV/Scalability_DTLZ4_3obj.csv}\ScalabilityDTLZFourThreeObj
\pgfplotstableread[col sep = comma]{CSV/Scalability_UF4_2obj.csv}\ScalabilityUFFourTwoObj
\pgfplotstableread[col sep = comma]{CSV/Scalability_UF10_3obj.csv}\ScalabilityUFTenThreeObj
...
\pgfplotstableread[col sep = comma]{CSV/Diversity2objWFG1.csv}\DiversityTwoWFGOne
\pgfplotstableread[col sep = comma]{CSV/Diversity3objWFG1.csv}\DiversityThreeWFGOne
