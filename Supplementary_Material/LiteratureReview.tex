...
%
Among the different indicators, hyper-volume is a widely accepted Pareto-compliance quality indicator.
%
...
%
A different approach was to modify the hyper-volume to integrate the decision space diversity 
